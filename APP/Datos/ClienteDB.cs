...
namespace Datos
{
    public class ClienteDB
    {
        ...
        public Boolean Insertar(Cliente cliente)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append(" INSERT INTO cliente VALUES (@Identidad, @Nombre, @Telefono, @Correo, @Direccion, @FechaNacimiento, @EstaActivo);");
        ...
        public DataTable DevolverClientesPorNombre(string nombre)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append(" SELECT * FROM cliente WHERE Nombre LIKE ('%" + nombre + "%');"); //LIKE, Es para filtrar valores todos los resultados que sean iguales al nombre
